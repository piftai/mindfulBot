...
// временные слоты на каждый день недели
...
const handleStartMessage = "Добро пожаловать в осознанные напоминания 🪷\n\n" +
...
func handleStart(bot *tgbotapi.BotAPI, msg *tgbotapi.Message) {
	message := tgbotapi.NewMessage(msg.Chat.ID, handleStartMessage)
